 ...
 */
class Collaborateur extends \GM\ProjetBundle\Entity\Collaborateur implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'GM\\ProjetBundle\\Entity\\Collaborateur' . "\0" . 'id', '' . "\0" . 'GM\\ProjetBundle\\Entity\\Collaborateur' . "\0" . 'user', '' . "\0" . 'GM\\ProjetBundle\\Entity\\Collaborateur' . "\0" . 'nom', '' . "\0" . 'GM\\ProjetBundle\\Entity\\Collaborateur' . "\0" . 'prenom', '' . "\0" . 'GM\\ProjetBundle\\Entity\\Collaborateur' . "\0" . 'email', '' . "\0" . 'GM\\ProjetBundle\\Entity\\Collaborateur' . "\0" . 'etat', '' . "\0" . 'GM\\ProjetBundle\\Entity\\Collaborateur' . "\0" . 'projets', '' . "\0" . 'GM\\ProjetBundle\\Entity\\Collaborateur' . "\0" . 'projetColab'];
        }
