 ...
 */
class Mission extends \GM\ProjetBundle\Entity\Mission implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'GM\\ProjetBundle\\Entity\\Mission' . "\0" . 'projets', '' . "\0" . 'GM\\ProjetBundle\\Entity\\Mission' . "\0" . 'id', '' . "\0" . 'GM\\ProjetBundle\\Entity\\Mission' . "\0" . 'dateDebut', '' . "\0" . 'GM\\ProjetBundle\\Entity\\Mission' . "\0" . 'dateFin'];
        }
